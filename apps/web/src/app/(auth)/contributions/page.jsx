...
import { Card, CardContent, Badge, Select, Divider, Pagination, KnowledgeArticleIcon, KnowledgeConceptIcon, KnowledgeThinkerIcon, KnowledgeBookIcon, KnowledgeSymbolIcon, KnowledgeCollectionIcon, FileIcon, CheckIcon, } from "@archron/ui";
const ALL_TYPES = [
    "Articles",
    "Concepts",
    "Thinkers",
      ...
      <div className="mx-auto max-w-container-page px-6 pb-24">
        ...
        <section className="mt-10">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <Select options={filterOptions} value={filter} onChange={(e) => { setFilter(e.target.value); setPage(1); }} className="w-full sm:w-48"/>
          ...
          <div className="space-y-8">
            ...
            return (<div key={group.type}>
                  ...
                  <div className="space-y-2">
                    {group.items.map((item) => (<Card key={item.id} className="transition-colors duration-[var(--motion-normal)] hover:border-primary/30">
            ...
            {grouped.length === 0 && (<div className="py-16 text-center">
                <p className="text-body text-text-muted">No contributions yet</p>
              </div>)}
          </div>

          {totalPages > 1 && (<div className="mt-10 flex justify-center">

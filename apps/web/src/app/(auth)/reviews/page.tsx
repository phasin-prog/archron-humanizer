...
const MOCK_PENDING_REVIEWS: Review[] = [
...
const MOCK_COMPLETED_REVIEWS: Review[] = [
...
function statusVariant(status: Review["status"]): "default" | "success" | "warning" | "destructive" {
  switch (status) {
          ...
          {pendingExpanded && (
            <div className="space-y-2">
              ...
              {MOCK_PENDING_REVIEWS.map((review) => (
                <Card key={review.id} className="transition-colors duration-[var(--motion-normal)] hover:border-primary/30">

...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-container-page px-6 pb-24 pt-10">
      {/* Header */}
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                {Object.entries(p.contributions).map(([type, count]) => (
                  <div key={type} className="rounded-lg border border-border bg-elevated p-3 text-center">
                ...
                {p.achievements.map((a) => (
                  <div
                    ...
                    className={`rounded-lg border p-3 text-center transition-opacity ${
                      a.earned ? "border-border bg-elevated" : "border-muted bg-card opacity-40"
                    }`}
                  >
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {p.collections.map((c) => (
                <div key={c.title} className="flex items-center justify-between rounded-lg border border-border bg-elevated p-4">
                  <div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {p.expertise.map((tag) => (
                  <Badge key={tag} variant="secondary" className="text-caption">{tag}</Badge>
                ))}
              </div>
            </CardContent>
          </Card>

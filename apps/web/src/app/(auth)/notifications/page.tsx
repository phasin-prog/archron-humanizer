    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-container-page px-6 pb-24 pt-24">
        ...
        {notifications.length === 0 ? (
          <section className="mt-16 flex flex-col items-center justify-center rounded-xl border border-border bg-card py-16">
                ...
                <div className="space-y-2">
                  {items.map((notification) => {
                    ...
                    return (
                      <Card
                        key={notification.id}
                        className={`cursor-pointer border-border transition-colors hover:border-primary/20 ${
                            ...
                            <div className="flex items-start justify-between gap-2">
                              <h3
                                className={`font-sans text-caption font-semibold ${
                                  !notification.read ? "text-text" : "text-text-muted"
                                }`}
                              >
                                {notification.title}
                              </h3>

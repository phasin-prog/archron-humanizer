    ...
    return (<div className="flex min-h-screen flex-col">
      ...
      <section className="mx-auto mt-20 w-full max-w-container-page px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map((i) => (<Link key={i} href={i === 1 ? "/concepts/structure-of-the-unconscious" : i === 2 ? "/concepts/archetypes" : "/concepts/the-shadow"} className="group rounded-xl border border-border bg-card p-5 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
      ...
      <section className="mx-auto mt-20 w-full max-w-container-page px-6">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          {[1, 2].map((i) => (<Link key={i} href={i === 1 ? "/guides" : "/guides"} className="group rounded-xl border border-border bg-card p-6 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
      ...
      <section className="mx-auto mt-20 w-full max-w-container-page px-6">
        ...
        ].map((item) => (<Link key={item.title} href={`/concepts/${item.title.toLowerCase().replace(/\s+/g, "-")}`} className="group rounded-xl border border-border bg-card p-4 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
              <div className="mb-2 flex items-center gap-2">
                <span className="rounded-full px-2 py-0.5 font-mono text-meta font-medium" style={{
      ...
      <section className="mx-auto mt-20 w-full max-w-container-page px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <Link href="/explore" className="group rounded-xl border border-border bg-card p-6 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
          ...
          <Link href="/timeline" className="group rounded-xl border border-border bg-card p-6 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
            <span className="text-2xl">⏳</span>
            <h3 className="mt-3 font-serif text-card-title font-semibold text-text group-hover:text-primary transition-colors">
              Timeline
            </h3>
          ...
          <Link href="/constellation" className="group rounded-xl border border-border bg-card p-6 transition-colors duration-[var(--motion-normal)] hover:border-primary/30 hover:bg-elevated">
            <span className="text-2xl">✦</span>
            <h3 className="mt-3 font-serif text-card-title font-semibold text-text group-hover:text-primary transition-colors">
              Constellation
            </h3>
      ...
      <footer className="mt-24 border-t border-border">
        <div className="mx-auto flex max-w-container-page flex-wrap items-center justify-center gap-6 px-6 py-10">
          <Link href="/support" className="text-caption text-text-muted transition-colors duration-[var(--motion-fast)] hover:text-primary">
            Support <span aria-hidden="true">☕</span>
          </Link>
          <Link href="/about" className="text-caption text-text-muted transition-colors duration-[var(--motion-fast)] hover:text-primary">
            About
          </Link>
          <Link href="/privacy" className="text-caption text-text-muted transition-colors duration-[var(--motion-fast)] hover:text-primary">
            Privacy
          </Link>
          <Link href="/terms" className="text-caption text-text-muted transition-colors duration-[var(--motion-fast)] hover:text-primary">
            Terms
          </Link>
        </div>
      </footer>

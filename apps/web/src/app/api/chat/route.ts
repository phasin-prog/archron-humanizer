...
export async function POST(request: Request) {
  ...
  if (lower.includes("shadow")) {
    return NextResponse.json({
      response:
        "The Shadow is one of Carl Jung's core archetypes. It represents the unconscious, repressed aspects of the personality — traits, desires, and impulses the conscious ego rejects or denies. Integrating the Shadow is central to individuation, the lifelong process of becoming whole.",
    })
  }

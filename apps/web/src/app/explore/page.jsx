...
import { KnowledgeConceptIcon, KnowledgeThinkerIcon, KnowledgeBookIcon, KnowledgeArticleIcon, KnowledgeSymbolIcon, KnowledgeTimelineEventIcon, KnowledgeGuideIcon, KnowledgeCollectionIcon, Card, CardContent, Button, ChevronRightIcon, } from "@archron/ui";
const domains = [
      ...
      <div className="mx-auto max-w-container-page px-6 pb-24">
        ...
        <section className="mt-20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-4">
            {objectTypes.map((type) => (<Link key={type.slug} href={`/search?type=${type.slug}`} className="group">

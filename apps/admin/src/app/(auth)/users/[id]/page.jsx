      ...
      <Card>
        <CardContent className="p-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-48">
              <Select options={ROLE_OPTIONS} value={role} onChange={handleRoleChange} placeholder="Select role"/>
            </div>
          ...
          {confirmVisible && (<div className="mt-4 rounded-md border border-destructive/30 bg-destructive/5 p-4">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <section>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="space-y-4">
                {AUDIT_TRAIL.map((entry) => (<div key={entry.id} className="flex items-start gap-3">
                    <div className="mt-1 h-2 w-2 shrink-0 rounded-full bg-muted-foreground/40"/>
                    <div>
                      <div className="flex items-center gap-2">

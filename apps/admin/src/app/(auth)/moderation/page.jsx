...
const HEADERS = ["Flag ID", "Content", "Type", "Reporter", "Date", "Status", "Actions"];
        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            <table className="w-full text-body">
              ...
              <tbody>
                {filtered.map((flag) => (<tr key={flag.id} className="border-b transition-colors hover:bg-muted/20">

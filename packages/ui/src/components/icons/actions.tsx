// Action Icons — 2px stroke, 24×24 viewBox, outline style
...
export function ExploreIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        d="M16 8L10 14L8 16L10 10L16 8Z"
        stroke="currentColor"
        strokeWidth="2"
...
export function ConstellationIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M6 6L12 18M12 18L18 6" stroke="currentColor" strokeWidth="2" />
    </svg>
  )
}
...
export function SortIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M11 5H3M13 12H3M16 19H3M18 5L21 8M21 8L18 11M21 8V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}

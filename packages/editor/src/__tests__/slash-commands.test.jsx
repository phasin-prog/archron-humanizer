...
import { BUILT_IN_SLASH_COMMANDS, createInitialState, validateMarkdown, countWords, estimateReadingTime, } from "../index";
describe("BUILT_IN_SLASH_COMMANDS", () => {
    ...
    it("includes the heading-1 command", () => {
        const h1 = BUILT_IN_SLASH_COMMANDS.find((c) => c.id === "heading-1");
...
describe("validateMarkdown", () => {
    ...
    it("runs each rule and collects matching results", () => {
        const always = {
            ...
            test: (md) => ({ ruleId: "always", message: `saw ${md.length} chars`, severity: "info" }),
        };
        const never = {
            id: "never",
            name: "Never fires",
